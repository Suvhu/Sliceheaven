...
export default function Pizza(props) {
  ...
  return (
    <>
        ...
        <div className="modal-dialog" style={{ backgroundColor: "black" }}>
          <div className="modal-content" style={{ backgroundColor: "#E4AE31" }}>
            ...
            <div className="modal-footer">
              ...
              <button
                disabled ={pizza.name.length<5 || pizza.price.length<1 || image1.length ===0}
                type="button"
      ...
      >
        <h1 style={{ color: "#178582", fontWeight: "bold" }}>Pizza </h1>
        {pizzas.map((pizza) => {
            return (
              <Pizzacard
                key={pizza._id}
        ...
        >
          ...
          >
            ...
            />
            <h5 style={{ fontWeight: "bold", color: "#178582" }}>
              add pizza 
            </h5>
          </div>
        </div>
