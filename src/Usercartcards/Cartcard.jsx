        ...
        <div className="d-flex" style={{ width: "65vw", height: "220px" }}>
          ...
          <div className="">
            <div className="card-body">
              ...
              <p className="card-text" style={{ color: "#0A1828" }}>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Architecto saepe sit explicabo perferendis, ea doloribus,
                ratione ducimus officiis ipsa doloremque incidunt? Ullam quod
                provident nam quae unde natus facere similique?
              </p>
              <p className="card-text">
                <small className="text-muted"> added on {cart.date}</small>
              </p>
            </div>
            <i
